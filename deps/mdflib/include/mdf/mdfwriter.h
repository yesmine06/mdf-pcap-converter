...
class MdfWriter {
 ...
 private:
  ...
  void CreateLinConfig(IDataGroup& dg_block) const;
  void CreateFlexRayConfig(IDataGroup& dg_block) const;
  void CreateEthernetConfig(IDataGroup& dg_block) const;
  void CreateBusDataFrameChannel(IChannelGroup& group, const std::string& prefix) const;
